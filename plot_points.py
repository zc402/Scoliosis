...
# Flip folder
flip_train_img_folder = path.join("data_spine", "image_flip", "training")
flip_train_label_folder = path.join("data_spine", "labels_flip", "training")
...
plot(flip_train_img_folder, flip_train_label_folder)
plot(train_img_folder, train_mat_folder)
